...
namespace Server_Manager.Databases
{
    public class Core
    {
        public List<CoreInformation> cores = new List<CoreInformation>()
        {
            ...
            new CoreInformation("KCauldron", "1481.148", "1.7.10", "CC6080255E72BDACD1DDEE6491FEDFB2"),
            new CoreInformation("KCauldron", "1492.152", "1.7.10", "009DCB31F9E002CAFD212A3DA9DD8F0C"),
